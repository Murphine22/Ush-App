...
import { Plus, Edit, Trash2, Save, X, Lock, TrendingUp, Ban, Shield } from 'lucide-react';

const ContributionsSection = () => {
  const { members, contributions, addContribution, updateContribution, deleteContribution } = useFinance();
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setFormData({ memberName: '', amount: '', description: '', date: new Date().toISOString().split('T')[0] });
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transition-colors duration-300">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Contributions</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Total: ₦{totalContributions.toLocaleString()} • {contributions.length} records
            </p>
          </div>
        </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-red-700 dark:text-red-300 mt-1">
                You can view contribution records but cannot add, edit, or delete them. Your administrative privileges are limited to announcements only.
              </p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mb-6 animate-fade-in">
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-800 dark:text-white"
                required
              >
          ...
          <div className="flex items-center space-x-3 mt-4">
            ...
            >
              ...
              <span>{editingId ? 'Update' : 'Add'} Contribution</span>
            </button>
            <button
              type="button"
      ...
      {/* Contributions Table - Visible to All */}
        ...
        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            {contributions.map((contribution) => (
              <tr key={contribution.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-blue-700 dark:text-blue-300 mt-1">
                To add, edit, or delete contributions, please log in as an administrator via the Settings button.
              </p>
            </div>
          </div>
        </div>
